...
export function ProfileApp({ initialProfile }: { initialProfile: InitialProfile }) {
  ...
  return (
    <div className="min-h-[calc(100dvh-68px)] bg-cream px-4 pt-28 pb-15 min-[641px]:px-5 min-[641px]:pt-28 min-[641px]:pb-20 min-[981px]:px-6 min-[981px]:pt-32 min-[981px]:pb-25 ph-mask">
