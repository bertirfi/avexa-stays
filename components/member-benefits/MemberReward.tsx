...
const tiers: Tier[] = [
  ...
  },
  {
    ...
    earn: '10%',
    unlock: 'Premium Unlocked: future premium services such as Jacuzzi & Home Spa on selected apartments.',
  },
  {
    name: 'PLATINUM',
    progress: '5 stays & 20 nights',
    earn: '12.5%',
    unlock: 'Executive Power: pay for your stay itself with AVX (2 AVX = 1 RON).',
  },
  {
    name: 'DIAMOND HERO',
    progress: '7 stays & 35 nights',
    earn: '15%',
    unlock: 'All-Inclusive Power: spend your AVX on absolutely anything — every extra at 1 AVX = 1 RON, bookings at 2 AVX = 1 RON — plus an exclusive physical gift upon arrival.',
    hero: true,
  },
];
