    ...
    <section className="bg-gold px-6 py-[clamp(90px,12vw,160px)] text-center text-ink md:px-10">
      <Reveal direction="up" className="mx-auto max-w-[800px]">
        ...
        <p className="mx-auto mt-8 max-w-[620px] text-[16px] leading-[1.75] text-ink-80 md:text-[17px]">
          <Sentences text="Earn AVEXA Coins (AVX) with every stay and craft your perfect experience. From early check-ins to mid-journey cleaning and surprise setups, your loyalty unlocks the exclusive AVEXIAN Vault. Use your coins to buy back your time and absolute comfort. 1 AVX = 1 RON — what you see is what you get." />
        </p>
      </Reveal>
    </section>
  );
