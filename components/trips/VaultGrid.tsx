 ...
 * "Reach {TIER} to unlock this experience"). BASIC already holds the whole AVX-08
  ...
  return (
    <div>
      ...
      <p className="mt-8 max-w-[640px] text-xs leading-relaxed text-white/55">
        <Sentences text="AVX Coins pay for every extra service from your very first coins — 1 AVX = 1 RON. PLATINUM and DIAMOND HERO exclusively can also pay for the stay itself — 2 AVX = 1 RON. AVX Coins are non-transferable and hold no cash value." />
      </p>
    </div>
  );
}
