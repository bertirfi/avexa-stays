/* Stay page data — The Golden Forest (Suite 201) */
const { useState, useEffect, useRef, useCallback } = React;

const PHOTOS = [
  { id:1, label:'Cover', src:'listing-201/00-cover.jpeg'},
  { id:2, label:'Bathroom', src:'listing-201/06-bathroom-green.jpeg'},
  { id:3, label:'Bathroom Full', src:'listing-201/10-bathroom-full.jpeg'},
  { id:4, label:'Hallway', src:'listing-201/19-hallway-entrance.jpeg'},
  { id:5, label:'Hallway Wide', src:'listing-201/23-hallway-wide.jpeg'},
  { id:6, label:'Building Door', src:'listing-201/25-building-door.jpeg'},
  { id:7, label:'Building Hall', src:'listing-201/26-building-hall.jpeg'},
  { id:8, label:'Building Hall', src:'listing-201/27-building-hall2.jpeg'},
  { id:9, label:'Exterior View', src:'listing-201/29-exterior-view.jpeg'},
  { id:10, label:'Living Room', src:'listing-201/32-apartment-view.jpeg'},
  { id:11, label:'Staircase', src:'listing-201/34-staircase.jpeg'},
];
...
const FAQ = [
  {question:'Can I park there?', answer:'Paid public parking is available on the street nearby at Piata Națiunilor parking, just across the street. Reservation is not needed.'},
  {question:'Is there a river view?', answer:'Yes — the apartment overlooks the Dâmbovița River, offering panoramic views from the living area. You are positioned at the gateway to the Old Town.'},
  {question:'Is the apartment family-friendly?', answer:'Yes. A crib (25 lei/night) and high chair are available upon request. Children of all ages are welcome. Children 6+ are charged as adults.'},
];

const AMENITIES_TOP = [
  'Free Wi-Fi','Air conditioning','Kitchen','Elevator','Washer','Hair dryer','Heating','Dishwasher','HDTV with Netflix','Private entrance',
];
...
const RATES = [
  {id:'saver', name:'Member Saver', perNight:109, discount:15, refundable:false,
  ...
  {id:'flex', name:'Member Flex', perNight:125, discount:5, refundable:true,
...
const TESTIMONIALS = [
  {name:'Julie', date:'May 2026', stay:'Stayed a few nights', rating:5, yearsOnPlatform:'13 years on Airbnb',
   text:'Traditional apartment in the heart of the City. Seconds away from all the sights and surrounded by shops, cafes and bars which made everything so easy. The apartment is large and comfortable and the espresso machine with good coffee was a real plus!'},
  {name:'Cris', location:'Irvine, California', date:'May 2026', stay:'Stayed a few nights', rating:5,
   text:'Absolutely amazing place, this was the second time I stayed here and I will return in the future for sure. Walking distance to so many places, from the Old Town, to the shopping center, subway. Clean, beautiful place with everything you need and more inside.'},
  {name:'Brittany', location:'Morgan, Utah', date:'April 2026', stay:'Stayed a few nights', rating:5,
   text:'Great Location! Old town restaurants & shopping are located right outside your door. Despite being located at a busy intersection, the apartment is quiet. I am a light sleeper and I slept great. The apartment is beautiful, completely updated and comfortable.'},
  {name:'Andie', date:'May 2026', stay:'Stayed a few nights', rating:5, yearsOnPlatform:'10 years on Airbnb',
   text:'We really enjoyed our stay here in the heart of Bucharest. The location is greatly placed to explore the sights around the old town. The apartment is well equipped and smartly furnished. It has everything you need for a city break. Loved our trip!'},
];
